        ...
        <div class="register_box">
            ...
            <!-- rules和prop属性都是校验相关的。
             ...
             <el-form ref="registerFormRef" :model="registerForm" :rules="registerFormRules" label-width="0px" class="register_form">
                ...
                <el-input v-model="registerForm.emailAdd.email" placeholder="Fill in your Unimelb email" prefix-icon="iconfont icon-email-fill"></el-input>
                </el-form-item>
                <span>Username</span> 
  ...
  methods: {
    ...
    register () {
      this.$refs.registerFormRef.validate(async valid => {
        ...
        if (re.meta.status !== 200) return this.$message.error('登录失败！')
