    ...
    <div class="body-wrapper">
        ...
        <div class="sites" id="site-list">
            ...
            <a v-for="item in portfolioList" >
                ...
                <i class="el-icon-close" style="position: absolute; color: gray; font-size: 20px; margin: 5px 0px; cursor: pointer;bottom: 55px; left: 80%" @click="handleDelete(item.siteId)"></i>
            </a>
        </div>
    </div>
</div>
...
export default {
    ...
    methods: {
        ...
        async handleDelete(id){
            var temp = {siteId: id}
            var data1 = this.$qs.stringify(temp)
